# Week 7 · Something is wrong with this model
...
Notebook: [`task_6_fashion_mnist_2k.ipynb`](task_6_fashion_mnist_2k.ipynb) [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/fiit-ba/zneus-2026/blob/main/labs/week_07_overfitting/task_6_fashion_mnist_2k.ipynb) (in Colab, replace `fiit-ba` in the URL with your GitHub username to open the copy in your fork).

## Data

Kaggle competition: the link is given at the lab. Download `train.npz` and `test.npz` from its *Data* tab into `labs/week_07_overfitting/data/kaggle/`.
...
Train the best classifier you can on the 2 000 images, log every run to Weights & Biases (project `zneus-2026`, run names `week07-...`) and submit your predictions for `test.npz` to Kaggle (`submission.csv`, columns `id,label`, 10 000 rows). Beat 0.80 on the leaderboard.
...
- [ ] public W&B link to the project `zneus-2026` with your week 7 runs
