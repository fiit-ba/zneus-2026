...
Train the best MLP you can, log every run to Weights & Biases (project `zneus-2026`, run names `week06-...`) and submit your predictions for `test.npz` to Kaggle (`submission.csv`, columns `id,label`, 10 000 rows).
